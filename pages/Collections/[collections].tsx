  ...
  return (
    <div className="">
      <div className="bg-white	md:pl-16 md:pr-16 pb-6">
        {FloorData && (
          <MainCollection Data={FloorData?.collections} loading={loading} />
        )}
      </div>
      {!data && <NFTPlaceholder />}
      <Listing />
      <div className="m-auto text-center	mt-20 mb-5">
        {data && (
          <button
            type="button"
            onClick={() => Loadmore()}
            className="m-auto text-white bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:focus:ring-yellow-900"
          >
            Load more
          </button>
        )}
