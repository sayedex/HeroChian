...
import {HighestVolumeCollections} from "../../graphql/Queries"
...
const Collectionslide = () => {
  ...
  const { data:collection, loading:load, networkStatus, error, refetch } = useGQLQuery(HighestVolumeCollections,{
    first:20
  });
...
{/* header */}
<div>
    <h1  className='font-bold m-auto text-xl relative w-fit 	md:text-2xl	'>Featured Collections</h1>
</div>
{/* header */}
<div>
{load && <Gridbox/>}
