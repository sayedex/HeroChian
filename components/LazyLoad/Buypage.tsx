...
<div className='flex flex-col gap-y-10 p-10 max-w-7xl m-auto mb-10'>

<div role="status" className="space-y-8 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center">
    <div className="flex items-center justify-center h-80 bg-gray-300 rounded max-w-2xl dark:bg-gray-700 md:w-2/4">
